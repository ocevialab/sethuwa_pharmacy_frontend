...
const Card: React.FC<{ title: string; description: string; isChecked: boolean }> = ({ title, description, isChecked }) => {
    return (
        <div className="hstack justify-content-between p-4 mb-3 border border-dashed border-gray-3 rounded-1 align-items-center">
            <div className="flex-grow-1 me-4">
                <div className="fw-bold mb-1 text-truncate-1-line">{title}</div>
