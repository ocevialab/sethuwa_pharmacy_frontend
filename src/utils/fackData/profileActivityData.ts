...
export const profileActivityData2 = [
    {
        ...
        description: 'pharmacy is a clean bootstrap admin dashboard, frontend and webapps template pack that built with most popular bootstrap framework and modern technology\'s.',
        badges: [
    ...
    {
        color: 'danger',
        title: 'Event start soon #pharmacy',
        description: 'pharmacy is a clean bootstrap admin dashboard, frontend and webapps template pack that built with most popular bootstrap framework and modern technology\'s.',
        badges: [
            {
                users: [
